<?php include('include/header.php') ?>
	...
	<div class="banner" style="background-image: url(assets/images/banner-bg.jpg);">
		...
		<div class="testimonials">
			<div class="container">
				<div class="owl-carousel owl-theme two-item-slide">
					<div class="item">
		...
		<div class="container">
			...
			<ul>
				<li>
					...
					<h4>Take A Pic</h4>
					<p>Take a picture of your ticket and driving license, to provide lawyers with crucial information to make a bid on your ticket.</p>
				</li>
				<li>
					<h6>Step 2</h6>
